			...
			getExecutorTypes() {
				...
				return {
					types: [
						...
						{ _id: ttypes.TypeByte, label: ttypes.TypeByte, parameterCount: 0, pattern: rexInt, max: 127 },
						{ _id: ttypes.TypeShort, label: ttypes.TypeShort, parameterCount: 0, pattern: rexInt, max: 32767 },
						{ _id: ttypes.TypeInteger, label: ttypes.TypeInteger, parameterCount: 0, pattern: rexInt, max: 2147483647 },
						{ _id: ttypes.TypeLong, label: ttypes.TypeLong, parameterCount: 0, pattern: rexInt, max: 9223372036854775807 }, //will round to 9223372036854776000
						{ _id: ttypes.TypeSingle, label: ttypes.TypeSingle, parameterCount: 0, pattern: rexFlt, max: 3.402823E+38 },
						{ _id: ttypes.TypeDouble, label: ttypes.TypeDouble, parameterCount: 0, pattern: rexFlt, max: Number.MAX_VALUE },
					...
					values: [
						...
						{ types: [ttypes.TypeSingle, ttypes.TypeDouble, ttypes.TypeDecimal], values: [-3.141592653, 0, 1, 3.141592653, 5.27e-9] },
