...
i18n.map('ru', {
  ...
  account: {
    ...
    logoutButton: 'выйти',
    logoutOtherClientsButton: 'завершить остальные сессии',
  ...
  exercise: {
    ...
    solutionFragmentLabel: 'Пример решения (исходный код)',
    ...
    help: {
      ...
      types: 'Для типов необходимо ввести одно из следующих значений. В качестве параметров типа может быть введён тип, или определённый пользователем класс.',
      values: 'Для значений необходимо ввести корректный формат в соответствии со следующими инструкциями и примерами. Для текста и чисел просто введите значение без кавычек. '
  ...
  examination: {
    ...
    configureExaminationSubtitle: 'Настройки экзамена',
    ...
    // executionType  // время выполнения
    // startTimeLabel  // начало
    // endTimeLabel  // конец
    // durationLabel  // длительность
    // durationUnitLabel  // мин
  ...
  form: {
    ...
    createdBy: 'создал(а)',
    editedBy: 'редактировал(а)',
    actionAt: 'в',
    createdByLabel: 'Создал(а)',
    editedByLabel: 'Редактировал(а)',
    editedAtLabel: 'Редактировалось в ',
    searchButton: 'поиск',
  ...
  programmingLanguages: {
    ...
    csharp: {
      // name
      description: '(си шарп) является объектно-ориентированным  мультипарадигменным (императивным и декларативным) языком программирования общего назначения, имеющим возможность функционального, обобщённого (шаблоны) и компонентно-ориентированного программирования.',
    },
    python: {
      // name
    ...
    javascript: {
      // name
      description: '(джаваскрипт) является стандартным скриптовым (динамическим) языком программирования Web приложений (и клиентской, и серверной части). Обычно применяется совместно с HTML и CSS.',
    },
    php: {
      // name
      description: '(пи аш пи) является широко используемым скриптовым языком программирования серверной части Web приложений. PHP является аббревиатурой от Personal Home Page (Персональная домашняя страница), а так же от PHP: Hypertext Preprocessor (Пи аш пи: гипертекст процессор).',
    },
    kotlin: {
      // name
    ...
    upcoming: {
      name: 'Иные',
      description: 'языки программирования могут быть добавлены. Ваши пожелания и помощь очень приветствуются. Присоединяйтесь!',
    },
  },
  error: {
    403: {
