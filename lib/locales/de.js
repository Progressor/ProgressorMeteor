(function () {
	...
	i18n.map('de', {
		layout: {
			...
			title: 'Prüfung',
			createTitle: 'Prüfung erstellen',
			editTitle: "Prüfung bearbeiten '{$1}'",
			releaseTitle: 'Prüfung veröffentlichen',
			searchSubtitle: 'Suche',
			exerciseSubtitle: 'Problem',
			categoryDescriptionSubtitle: 'Anleitung für {$1} Prüfung',
			releasedSubitle: 'Veröffentlichungen bestätigt',
			editBreadcrumb: 'Prüfung bearbeiten',
			exam: 'Prüfung',
			exams: 'Prüfungen',
			upcoming: 'noch nicht verfügbar...',
			nameLabel: 'Name',
			descriptionLabel: 'Beschreibung',
			solvedLabel: 'Gelöst',
			editButton: 'Prüfung bearbeiten',
			duplicateButton: 'duplizieren',
			archiveButton: 'archiviere Exam',
			closeButton: 'Geschlossen',
			isNotValidMessage: 'Dieses Prüfung ist nicht gültig und kann nicht gespeichert werden.\nBitte füllen Sie alle nötigen Felder aus.\nüberprüfen Sie ob alle ausgefüllten Felder richtig sind'
