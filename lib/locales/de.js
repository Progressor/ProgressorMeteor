	...
	i18n.map('de', {
		layout: {
			...
			releaseNotifier: {
				...
				intro: 'Hallo {$1}\nEs sind neue {$2}Anfragen zur Freigabe von Aufgaben{$3} eingegangen.\nBitte überprüfe diese offenen Anfragen.'
			},
			verifyEmail: {
				subject: 'Progressor - E-Mail-Adressen Verifizierung',
				title: 'E-Mail-Adressen Verifizierung ',
				intro: 'Hallo {$1}\nWillkommen bei {$2}Progressor - The Programming Professor.{$3}\nUm deine E-Mail-Adresse zu verifizieren, klicke bitte auf den untenstehenden Link.',
				info: 'Du kannst auf deiner Kontoseite auch noch deinen {$1}richtigen Namen{$2} eingeben.\nDu kannst sofort loslegen und bestehende Aufgaben lösen.\nDu kannst auch deine eigenen Aufgaben erstellen und mit deinen Freunden teilen.',
				motivation: 'Viel Spass beim Programmieren lernen! :-)'
			},
			resetPassword: {
				subject: 'Progressor - Passwort zurücksetzen',
				title: 'Passwort zurücksetzen',
				intro: 'Hallo {$1}\nUm dein Passwort zurückzusetzen, klicke bitte auf den untenstehenden Link und gib dein neues Passwort ein.'
			}
