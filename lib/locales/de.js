(function () {
	...
	i18n.map('de', {
		layout: {
			...
			pwdResetError: 'Ein unerwarteter Fehler ist aufgetreten!\nPasswort zurücksetzen fehlgeschlagen.\nBitte versuche es noch einmal oder fordere einen neuen Link an\num dein Paawort zurückzusetzen',
			pwdResetSuccess: 'Passwort wurde erfolgreich zurückgesetzt\nDu bist jetzt mit deinem neuen Passwort eingeloggt.'
			...
			resetPassword: {
				...
				intro: 'Hallo {$1}\nUm dein Passwort zurückzusetzen klicke bitte auf den Link unten und gib dein neues Passwort ein.'
			}
		}
	});
