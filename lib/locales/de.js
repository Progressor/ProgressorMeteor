(function () {
	...
	i18n.map('de', {
		layout: {
			...
			editTemplateTitle: "Prüfung bearbeiten '{$1}'",
			...
			totalExamineesLabel: 'Anzahl Prüfungskandidaten',
			progressLabel: 'Fortschritt',
			exerciseNumberLabel: 'Anzahl Aufgaben',
			progressInstructionSubtitle: 'Erklärungen zur Fortschrittsanzeige',
			resultLogInstructionSubtitle: 'Erklärungen zum Logging',
			addTimeButton: 'Zeit erhöhen',
			overviewButton: 'Prüfungsübersicht',
			addExerciseButton: 'Aufgabe zu Prüfung hinzufügen',
			templateIsNotValidMessage: 'Diese Prüfung ist nicht gültig und kann nicht gespeichert werden.\nFüllen Sie alle obligatorischen Felder (Name/n, Beschreibung/en, Dauer, Aufgaben inkl. Gewichtung) aus.',
			...
			progressInstructionMessage: 'Rot: Noch nicht beantwortet\nGelb: Teilweise gelöst\nGrün: Korrekt gelöst\nBlau: Beantwortet (keine automatische / sichtbare Korrektur)',
			resultLogInstructionMessage: 'Evaluationen: Anzahl der Evaluationen (Speichern / Kompilieren) in den letzten {$1} Minuten\nAktionen: Durschnittliche Anzahl der Aktionen (Tastenanschlag / Mausklick) pro Sekunde\nZeichen: Durschnittliche Anzahl eingetippte Zeichen pro Sekunde (negative Zahl: mehr Zeichen gelöscht als eingetippt)\nRotes Kreuz: Keine Aktivität seit mindestens {$2} Minute',

			createTitle: 'Erstelle Durchführung',
			editTitle: "Durchführung Bearbeiten'{$1}'",
			examineesSubtitle: 'Teilnehmer',
			examineesRules: 'Werden keine Teilnehmer ausgewählt, wird die Durchführung für alle durchführbar sein.',
			examinees: 'Teilnehmende',
			addExamineeLabelButton: 'Teilnehmer hinzufügen',
			nameLabel: 'Studenten Name'
