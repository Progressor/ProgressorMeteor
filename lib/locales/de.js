(function () {
	...
	i18n.map('de', {
		layout: {
			...
			archiveSubtitle: 'Archiv',
			archiveButton: 'archivieren',
			unarchiveButton: 'wiederherstellen',
			archivedTypeLabel: 'Archivierter Dokumenttyp',
			createdExamsSubtitle: 'Erstellte Prüfungsvorlagen',
			createdExecutionSubtitle: 'Erstellte Prüfungsdurchführungen',
			...
			overviewTitle: 'Prüfungsübersicht',
			...
			executionTypeTitle: 'Prüfungsdurchführung',
			examTypeTitle: 'Prüfungsvorlage',
