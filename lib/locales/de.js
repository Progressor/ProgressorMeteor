(function () {
	...
	i18n.map('de', {
		layout: {
			...
			archiveTooltip: 'archiviere ausgewählte Aufgabe',
			revertArchiveTooltip: 'Archivierung der ausgewählten Aufgabe rückgängig machen',
			...
			accountSettingsPanel: 'Account Einstellungen'
			...
			editedLabel: 'Zuletzt bearbeitet / Editor',
