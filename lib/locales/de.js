	...
	i18n.map('de', {
		layout: {
			...
			java: {
				...
				//name
				description: '(englisch für Rubin) ist eine höhere Programmiersprache, die Mitte der 1990er Jahre von dem Japaner Yukihiro Matsumoto entworfen wurde.'
			}, swift: {
				//name
				description: 'ist eine Programmiersprache von Apple für iOS, OS X, tvOS, watchOS und Linux, die auf der Entwicklerkonferenz WWDC 2014 vorgestellt wurde.'
			}, lisp: {
				//name
				description: 'ist eine Familie von Programmiersprachen, die 1958 erstmals spezifiziert wurde und am Massachusetts Institute of Technology (MIT) in Anlehnung an den Lambda-Kalkül entstand. Es ist nach Fortran die zweitälteste Programmiersprache, die noch verbreitet ist.'
			}, vbnet: {
				//name
				...
				//name
				description: '(Structured Query Language, strukturierte Abfragesprache) ist eine Datenbanksprache zur Definition von Datenstrukturen in relationalen Datenbanken sowie zum Bearbeiten (Einfügen, Verändern, Löschen) und Abfragen von darauf basierenden Datenbeständen.'
			}
