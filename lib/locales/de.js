(function () {
	...
	i18n.map('de', {
		layout: {
			...
			navigationToggle: 'Navigation ein/ausblenden',
			...
			checkAnswerButton: 'Antwort prüfen',
			...
			actionAt: 'um',
			cannotSave: 'Sie sind nicht berechtigt, dieses Dokument zu speichern.',
			documentChanged: 'Das geöffnete Dokument wurde gerade verändert.\nFalls Sie fortfahren, werden Sie die Änderungen überschreiben. Eventuell möchten Sie es stattdessen neu laden.',
