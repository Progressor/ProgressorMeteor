(function () {
	...
	i18n.map('de', {
		layout: {
			...
			createdExercisesSubtitle: 'Erstellte Aufgaben',
			archivedExercisesSubtitle: 'Archivierte Aufgaben',
			...
			stratTimeLabel: 'Startzeit',
			durationLabel: 'Dauer',
			weightPtsUnitLabel: 'pkt',
			//durationUnitLabel
			//weightPercentUnitLabel
			//enumerationLabel
			ptsWeightLabel: 'Gewichtung in pkt',
			percentWeightLabel: 'Gewichtung in %',
			totalWeightLabel: 'Gesamtgewichtung',
			progressLabel: 'Fortschritt',
			examOverviewLabel: 'Prüfungsübersicht',
			examExercisesLabel: 'Prüfungsaufgaben',
			nextLabel: 'weiter',
			...
			help: {
				progress: 'ROT: Keine Lösung abgegeben\nGELB: Abgebene Lösung ist nicht korrekt\nGRÜN: Abgegebene Lösung ist korrekt\nBLAU: Abgegebene Lösung muss von Hand korrigiert werden'
			}
