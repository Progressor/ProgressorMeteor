	...
	i18n.map('de', {
		layout: {
			...
			'function': {
				...
				testCaseVisibleMessage: 'Ob der Testfall für die Studenten sichtbar sein soll.',
				solutionVisibleMessage: 'Ob die Beispiellösung für die Studenten sichtbar sein soll.'
