...
i18n.map('de', {
  ...
  account: {
    ...
    logoutOtherClientsButton: 'aus anderen Sitzungen abmelden',
  ...
  exercise: {
    ...
    importFileSubtitle: 'Zu importierende Dateien',
    importTableSubtitle: 'Zu importierende Aufgaben und Kategorien',
    ...
    exportedLabel: 'Exportiert um',
    numberOfCategoriesLabel: '#Kategorien',
    numberOfExercisesLabel: '#Aufgaben',
    ...
    importButton: 'Aufgaben & Kategorien importieren',
    ...
    notYetImportedMessage: 'Diese Aufgabe muss noch importiert werden.',
    importedMessage: 'Diese Aufgabe wurde erfolgreich importiert.',
    function: {
