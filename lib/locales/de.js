(function () {
	...
	i18n.map('de', {
		layout: {
			...
			releaseNotifier: {
				subject: 'Progressor Admin - Neue Anfragen Aufgaben freizugeben',
				salutation: 'Hallo {$1}',
				introLine1: 'Es sind einige neue Anfragen um Aufgaben freizugeben eingetroffen.',
				intorLine2: 'Als Administrator überprüfe bitte die hängingen Anfragen Aufgaben freizugeben.',
				newRequests: 'Neue Anfragen',
				gratitude: 'Vielen Dank für deine Mithilfe!',
