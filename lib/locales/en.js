(function () {
	...
	i18n.map('en', {
		layout: {
			...
			stratTimeLabel: 'Start time',
			durationLabel: 'Duration',
			durationUnitLabel: 'min',
			weightPtsUnitLabel: 'pts',
			weightPercentUnitLabel: '%',
			enumerationLabel: '#',
			ptsWeightLabel: 'Weight in pts',
			percentWeightLabel: 'Weight in %',
			totalWeightLabel: 'Total weight',
			progressLabel: 'Progress',
			examOverviewLabel: 'Exam overview',
			examExercisesLabel: 'Exam exercises',
			nextLabel: 'next',
			...
			help: {
					progress: 'RED: No solution delivered\nYELLOW: Solution delivered is incorrect\nGREEN: Solution delivered is correct\nBLUE: Solution delivered has to be corrected manually'
			}
