(function () {
	...
	i18n.map('en', {
		layout: {
			...
			solvedLabel: 'Solved',
			yourSolutionLabel: 'Your solution',
			...
			changedMessage: 'This exercise has been changed since you solved it. You might want to view the up-to-date version.',
			...
			cannotSave: 'You are not authorised to save this document.',
			documentChanged: 'The currently opened document has been changed.\nIf you continue, you will overwrite these changes. You might want want to reload it instead.',
