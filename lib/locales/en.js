(function () {
	...
	i18n.map('en', {
		layout: {
			...
			archiveSubtitle: 'Archive',
			archiveButton: 'archive',
			unarchiveButton: 'revert archiving',
			archivedTypeLabel: 'Archived document type',
			accountSettingsSubtitle: 'Account Settings',
			createdExamsSubtitle: 'Created exam templates',
			createdExecutionSubtitle: 'Created exam executions',
			...
			executionTypeTitle: 'Exam execution',
			examTypeTitle: 'Exam template',
