(function () {
	...
	i18n.map('en', {
		layout: {
			...
			solvedLabel: 'Solved',
			editButton: 'edit exam',
			duplicateButton: 'duplicate',
			archiveButton: 'archive exam',
			closeButton: 'Close',
			isNotValidMessage: 'This examination is not valid. Please check if you filled all the required Fields correctly',
			searchTitle: '{$1} exams',
			deleteButtonTitle: 'Delete All',
			saveButtonTitle: 'Save',
			addExerciseToExamLabel: 'Add to Exam',
			exercisesIncludedTitleLabel: 'Exercises Included in the Examination',
			savedMessage:'',
			exerciseWeightingLabel: 'Weighting',
			byUsername: 'By Username',
			byLink: 'By Link',
			participants: 'Participants',
			participantType: 'How do you want to add the exams participants',
			...
			executionIsNotValidMessage: 'This examination is not valid and cannot be saved.\nFill in all the mandatory fields (name(s), description(s) ,duration, exercises incl. weight).',

			startExecutionButton:'Start Execution',
			createTitle: 'Create Execution',
			editTitle: "Edit execution '{$1}'",
			examineesSubtitle: 'Examinees',
			examineesRules: 'If none are chosen the exam will be public. Anybody will be able to do the exam',
			examinees: 'Examinee(s)',
			addExamineeLabelButton: 'Add Examinee',
			nameLabel: 'Examinee',
			totalWeightLabel: 'Total Weight',
			totalExamineesLabel: 'Total Examinees',
			progressLabel: 'Progress',
			exerciseNumberLabel: 'Number of Exercises',
			progressInstructionSubtitle: 'Progress Explanations',
			resultLogInstructionSubtitle: 'Logging Explanations',
			addTimeButton: 'add extra time',
			overviewButton: 'exam overview',
			addExerciseButton: 'add exercise to examination',
			progressInstructionMessage: 'Red: Not yet answered\nYellow: Partially solved\nGreen: Successfully solved\nBlue: Answered (no automated / visible evaluation)',
			resultLogInstructionMessage: 'Evaluation: Number of evaluations (save / compile) in last 5 minutes\nActions: Average number of actions (key stroke / mouse click) per second\nCharacter: Average number of entered characters per second (negative number: more characters deleted than entered)\nRed cross: No activity for at least {$2} minute'
