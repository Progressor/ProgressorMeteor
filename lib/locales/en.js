(function () {
	...
	i18n.map('en', {
		layout: {
			...
			title: 'Progressor - The Programming Professor',
			releaseNotifier: {
				subject: 'Progressor Admin - New exercise release requests',
				salutation: 'Hello {$1},',
				introLine1: 'You have some new exercise release requests.',
				introLine2: 'As administrator please review the pending release requests.',
				newRequests: 'New Requests',
				gratitude: 'Thanks a lot for your help!',
