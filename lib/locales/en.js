...
i18n.map('en', {
  ...
  exercise: {
    ...
    importFileSubtitle: 'Files to Import',
    importTableSubtitle: 'Exercises & Categories to Import',
    ...
    exportedLabel: 'Exported At',
    numberOfCategoriesLabel: '#Categories',
    numberOfExercisesLabel: '#Exercises',
    ...
    closeButton: 'close',
    importButton: 'import exercises & categories',
    ...
    notYetImportedMessage: 'This exercise has yet to be imported.',
    importedMessage: 'This exercise has been successfully imported.',
    function: {
