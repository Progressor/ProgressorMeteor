(function () {
	...
	i18n.map('en', {
		layout: {
			...
			archiveTooltip: 'archive selected exercise',
			revertArchiveTooltip: 'revert archiving of selected exercise',
			saveTooltip: 'save recent changes',
			solvedExercisesPanel: 'My solved exercises',
			createdExercisesPanel: 'Created exercises',
			archivedExercisesPanel: 'Archived exercises',
			accountSettingsPanel: 'Account settings'
			...
			editedLabel: 'Last edited / Editor',
			...
			'function': {
				...
				successMessage: 'Successfully executed test cases.',
				failureMessage: 'Not all test cases executed successfully.'
			}, help: {
				title: 'Instructions',
