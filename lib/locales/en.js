(function () {
	...
	i18n.map('en', {
		layout: {
			...
			verificationError: 'An unexpected error occured!\nEmail verification failed.\nPlease try again.',
			verificationSuccess: 'Email successfully verified!\nYou are logged in now.',
			pwdResetError: 'An unexpected error occured!\nPassword reset failed.\nPlease try again or request a new password reset link.',
			pwdResetSuccess: 'Password successfully reseted!\nYou are logged in now with your new password.'
			...
			releasedSubitle: 'Release Confirmed',
			...
			releaseNotifier: {
				...
				title: 'Exercise release requests notifier',
				intro: 'Hello {$1}\nYou have some new {$2}exercise release requests.{$3}\nAs administrator please review the pending release requests.'
			},
			verifyEmail: {
				subject: 'Progressor - Email verification',
				title: 'Email verification',
				intro: 'Hello {$1}\nWelcome to {$2}Progressor - The Programming Professor.{$3}\nTo verify your account email, please click the link below.',
				info: 'In your account overview, please register your {$1}real name{$2}.\nIf you wish to create your own exercises just click on Create Exercise.',
				motivation: 'Have fun with learning programming :)'
			},
			resetPassword: {
				subject: 'Progressor - Reset password',
				title: 'Reset password',
				intro: 'Hello {$1}\nTo reset your password, please click the link below and prompt your new password.'
			}
		}
	});
