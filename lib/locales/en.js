(function () {
	...
	i18n.map('en', {
		layout: {
			...
			numberOfExamineesLabel: 'Total Examinees',
			...
			help: {
				...
				examinees: 'If none are chosen the exam will be public. Anybody will be able to do the exam',
