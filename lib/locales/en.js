(function () {
	...
	i18n.map('en', {
		layout: {
			...
			editTitle: "Edit Exam '{$1}'",
			releaseTitle: 'Release Exam',
			searchSubtitle: 'Search',
			exerciseSubtitle: 'Problem',
			categoryDescriptionSubtitle: 'Instructions for {$1} Exam',
			releasedSubitle: 'Release Confirmed',
			editBreadcrumb: 'Edit Exam',
			exam: 'exam',
			exams: 'exams',
			upcoming: 'coming soon...',
			nameLabel: 'Name',
			...
			closeButton: 'Close',
			isNotValidMessage: 'Dieses Prüfung ist nicht gültig und can nicht gespeichert werden. \nBitte füllen Sie alle nötigen Felder aus\nüberprüfen Sie ob alle ausgefüllten Felder richtig sind',

			searchTitle: '{$1} exams',
			deleteButtonTitle: 'Delete All',
			saveButtonTitle: 'Save',
			addExerciseToExamLabel: 'Add to Exam',
			categotyTypeLabel: 'Category type',
			exercisesIncludedTitleLabel: 'Exercises included in the Exam',
