Progressor = (function () {
	...
	return {
		...
		getProgrammingLanguage: l => _.findWhere(programmingLanguages, { _id: l }) || _.findWhere(programmingLanguagesUpcoming, { _id: l }),
		getDifficulties: () => difficulties,
		getExerciseTypes: () => exerciseTypes,
		getExerciseType: i => _.findWhere(exerciseTypes, { _id: i })
	};
