					...
					switch (exercise.type) {
						case 1: //programming
							...
							_.each(exercise.testCases, (testCase, testCaseIndex) => {
								...
								if (result)
									pdf.fontRegular(testCaseSize).text(Progressor.getActualTestCaseOutput(exercise, testCase, result.results), testCaseX2 + testCaseSize / 2, y1 + testCaseHeight + testCaseSize / 2,
