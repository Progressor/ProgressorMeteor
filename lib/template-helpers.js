...
Template.registerHelper('floor', Math.floor);
Template.registerHelper('ceil', Math.ceil);
...
Template.registerHelper('i18nCategoryName', i18n.getCategoryName);
...
if (Meteor.isClient) {
  ...
  Template.registerHelper('i18nTooltips', () => {
