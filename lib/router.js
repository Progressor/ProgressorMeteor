	...
	Router.route('/account', {
		...
		data() {
			return {
				...
				authoredExercises: Progressor.exercises.find({$or : [ {author_id: Meteor.userId(), archived: { $exists : false }},{author_id: Meteor.userId(), archived: false}] }, { sort: { lastEdited: -1 } }).fetch(),
