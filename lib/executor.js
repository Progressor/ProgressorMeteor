(function () {
	...
	_.extend(Progressor, {
		...
		hasInvisibleTestCases: e => e.testCases && _.any(e.testCases, c => !c.visible),
		...
		isExerciseFailure: (e, r) => r && r.length && _.any(r, i => !i.success),
		...
		getVisibleResults: (e, r) => e.testCases ? _.chain(r).zip(e.testCases).filter(z => z[1].visible).map(z => z[0]).value() : r
	});
