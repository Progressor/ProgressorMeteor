(function () {
	...
	_.extend(i18n, {
		...
		getProperties(doc, prp, lng, flb = true) { //TODO: merge with getProperty
			if (!_.isArray(doc) && _.isObject(doc) && _.has(doc, prp))
				doc = doc[prp];
			if (_.isArray(doc)) {
				let res = _.findWhere(doc, { language: lng }) || (flb ? _.findWhere(doc, { language: defaultLanguage }) : null);
				return _.isObject(res) && _.has(res, prp) ? res[prp] : [];
			}
		},
		...
		getOptions: doc => i18n.getProperties(doc, 'options', i18n.getLanguage()),
		getOptionsForLanguage: (doc, lng) => i18n.getProperties(doc, 'options', lng, false),
